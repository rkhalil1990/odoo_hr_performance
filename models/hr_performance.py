...
class HrPerformanceBonusTotal(models.Model):  # 奖金计算汇总new
    ...
    pickl_other_datas_dict = fields.Text(u'序列化其他奖金明细')
...
class HrPerformanceSumGroup(models.Model):  #
    ...
    role = fields.Char(u'角色')
    role1 = fields.Char(u'角色1')
    total_name = fields.Integer(u'计数项:柜员名')
    avg_lrjj = fields.Float(u'平均值项:录入奖金', digits=(5, 2))
    avg_lrzlj = fields.Float(u'平均值项:录入质量奖', digits=(5,2))
    avg_fhjj = fields.Float(u'平均值项:复核奖金', digits=(5, 2))
    avg_zlfhj = fields.Float(u'平均值项:资料复核考核奖(20)', digits=(5, 2))
    avg_xykkhj = fields.Float(u'平均值项:信用卡差错业务考核奖', digits=(5, 2))
    avg_ccjj = fields.Float(u'平均值项:差错奖金(22)', digits=(5, 2))
    avg_xykjc = fields.Float(u'平均值项:信用卡纠错奖金(24)', digits=(5, 2))
    avg_shjj = fields.Float(u'平均值项:审核奖金(34)', digits=(5, 2))
    avg_hhqrj = fields.Float(u'平均值项:行号确认奖（35）', digits=(5, 2))
    avg_xykjj = fields.Float(u'平均值项:信移卡检件奖(36)', digits=(5, 2))
    avg_xykjjfh = fields.Float(u'平均值项:信移卡检件复核奖(37)', digits=(5, 2))
    avg_wl = fields.Float(u'平均值项:外联奖金（38）', digits=(5, 2))
    avg_bzjj = fields.Float(u'平均值项:按标准奖金考核奖（53）', digits=(5, 2))
    avg_btjj = fields.Float(u'平均值项:各岗位补贴奖金(54)', digits=(5, 2))
    avg_zzkhj = fields.Float(u'平均值项:组长考核奖(55)', digits=(5, 2))
    avg_qita = fields.Float(u'平均值项:其他加(56)', digits=(5, 2))
    avg_jjin = fields.Float(u'平均值项:奖金小计', digits=(5, 2))
